...
const NewsAndInsights = () => {
  ...
  return (
    ...
    <div style={{ marginTop: '30px', textAlign: 'center', color: '#16214f' }}>
      <h1 style={{ position: 'relative' }}>
      Stay Ahead of the&nbsp;
        <span style={underlineStyles}>  Curve:  Essential Legal </span>
        &nbsp;Updates for Businesses
      </h1>
      <br></br>
    </div>

    <h2 style={{...underlineStyles,color: '#16214f', marginLeft: '10px'}}>Blogs:</h2>
    <div>
    <a href='/news-and-insights/why-does-every-business-need-an-outsourced-legal-department?' style={{textDecoration: 'none'}}
    //  onClick={(e) => { e.preventDefault(); }}
     >
    <div style={blogStyles}>
      <img src={blog1} alt="1st Blog" style={blogImageStyles}
      onMouseEnter={(e) => (e.target.style.transform = 'scale(1.1)')}
        onMouseLeave={(e) => (e.target.style.transform = 'scale(1)')}

        ></img>
      <br></br>
      <h5 style={{color: '#fff',marginLeft: '10px',marginRight: '10px'}}>WHY DOES EVERY BUSINESS NEED AN OUTSOURCED LEGAL DEPARTMENT?</h5>
      <h6 style={{color: 'white',marginTop: '5px',marginLeft: '220px', marginRight: '10px'}}>22 Jan 2024</h6>
      <button style={{padding: 'px',backgroundColor: '#d5984e',color: 'white', width: '35%',height: '40px' ,border: '1px solid white', borderRadius: '5px', alignItems: 'center', justifyItems:'center',justifyContent: 'center', alignContent: 'center', alignItems: 'center', textAlign: 'center', }} onMouseEnter={(e) => (e.target.style.transform = 'scale(1.1)')}
        onMouseLeave={(e) => (e.target.style.transform = 'scale(1)')}>READ</button>
      <br></br>
    </div>
    </a>
    <div></div>
